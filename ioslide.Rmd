...
```{r fig.cap = "Kraft seiner starken Wurzeln wird er alle Mauern sprengen (links Egon Bahr, rechts Willy Brandt) (Wolfgang Hicks, 1972)",echo = FALSE}
...
```{r fig.cap = "Palast der Republik (Lutz Schramm)", echo = FALSE}

knitr::include_graphics("palast.jpg")

```

```{r fig.cap = "Erichs Lampenladen (Bildagentur für Kunst, Kultur und Geschichte / Gerhard Kiesling)", echo = FALSE}
...
```{r fig.cap = "Berliner Schloss 1950 (Förderverein Berliner Schloss e.V.)" ,echo = FALSE}
...
```{r fig.cap = "Die DDR hat's nie gegeben (dpa)", echo = FALSE}
